...
# Only run baselines-as-ensemble
RUN_7B_SPLIT_AL50=true
RUN_7B_SPLIT_RAND50=true

RUN_BASELINES=true  # part* (no -al50/-rand50) evaluated as ensemble
...
for SPLIT in 20 25 33 50; do
  ...
  # AL50/RAND50 disabled above
done

# ───────── 14B SPARSE: full-dataset single-adapter runs (disabled) ─────────
# kept for completeness; toggles are false
