...
# ===== CONFIG =====
BASE_MODEL="/home/models/Qwen_Sparse/Qwen3-4B-Sparse-0.33"
SPLIT="33"
SPLIT_DIR="/home/aneek/LLM-Adapters/ft-training_set/split_${SPLIT}"
OUT_ROOT="./trained_models/Qwen3-4B-Sparse/Qwen3-4B-Sparse-0.33-Ensemble_split_${SPLIT}"
RUN_STEM="Qwen3-4B-Sparse-0.33"
...
# ===== Run FT + AL (rand50, al50) over 3 parts =====
for p in 1 2 3; do
  PART_JSON="${SPLIT_DIR}/math_14k_part${p}_of_3.json"
...
echo "[DONE] runs for parts 1..3 under: ${OUT_ROOT}"