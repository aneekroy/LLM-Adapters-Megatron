...
# ====== Config ======
GPU="${GPU:-2}"  # override with: GPU=0 ./run_eval_math.sh
PY="${PY:-python}"
...
OUTDIR="${OUTDIR:-./eval_logs/Qwen3-4B-Sparse-0.50-Ensemble-FT-MathEval}"
  ...
  CUDA_VISIBLE_DEVICES="${GPU}" \
    "${PY}" "${EVAL_PY}" \
      ...
      --base_model "${BASE_MODEL}" \
        --lora_weights "part1=/home/aneek/LLM-Adapters/trained_models/Qwen3-4B-Sparse/Qwen3-4B-Sparse-0.50-Ensemble_split_50/Qwen3-4B-Sparse-0.50-Math14k-part1,part2=/home/aneek/LLM-Adapters/trained_models/Qwen3-4B-Sparse/Qwen3-4B-Sparse-0.50-Ensemble_split_50/Qwen3-4B-Sparse-0.50-Math14k-part2" \
        --tp_size 1 \
        --batch_size 16 \
