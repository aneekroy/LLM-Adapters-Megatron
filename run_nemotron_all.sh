...
SPARSE_MODELS=(
  "OpenReasoning-Nemotron-7B-Sparse-0.67"
  "OpenReasoning-Nemotron-7B-Sparse-0.75"
  "OpenReasoning-Nemotron-7B-Sparse-0.80"
)
...
echo "[DONE] Dense 7B-sparse (0.67/0.75/0.80) over Math14k: full, rand50, al50."